...
// REPLACE the old generatePdf function with this new one.
async function generatePdf() {
    ...
    try {
        const data = getTemplateData(); // This uses the helper function we already have
        
        // This new version builds the HTML content directly in JavaScript.
        // This AVOIDS the error from trying to fetch a file that doesn't exist.
        const proposalHtml = `
            <html>
            <head>
                <style>
            ...
            <body>
                <div class="header">
                    <img src="https://i.ibb.co/L5r4w3B/uctel-logo.png" alt="UCtel Logo" style="width: 200px;">
